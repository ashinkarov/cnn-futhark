...
proof assistant and some high-performance language of our choice.
...
into SaC (functional array language) and C (low-level imperative language).
...
\begin{enumerate}
  ...
  \item an extraction mechanism for generating SaC or C code from the DSL; and
