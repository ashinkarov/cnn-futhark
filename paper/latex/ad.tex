...
\AgdaModule{Array}\AgdaSpace{}%
\AgdaKeyword{hiding}\AgdaSpace{}%
\AgdaSymbol{(}\AgdaDeadcode{\AgdaUnderscore{}++\AgdaUnderscore{}}\AgdaSymbol{;}\AgdaSpace{}%
\AgdaFunction{Ix}\AgdaSymbol{)}\<%
\\
%
\>[2]\AgdaKeyword{open}\AgdaSpace{}%
\AgdaModule{Lang}\<%
...
\AgdaBound{e}\AgdaSpace{}%
\AgdaSymbol{=}%
\>[1745I]\AgdaFunction{printf}\AgdaSpace{}%
...
\AgdaSymbol{=}\AgdaSpace{}%
\AgdaFunction{printf}%
\>[1777I]\AgdaString{"(isum\%u\ \%s\ (\textbackslash{}\textbackslash{}\ \%s\ ->\ \%s))"}\AgdaSpace{}%
...
\>[1946I]\AgdaSymbol{(}\AgdaFunction{printf}\AgdaSpace{}%
\AgdaString{"(\%s\ /\ \%s)"}\AgdaSpace{}%
\AgdaBound{x}\AgdaSpace{}%
...
\AgdaSymbol{=}\AgdaSpace{}%
\AgdaFunction{printf}%
\>[2415I]\AgdaString{"if\ (\%s\ \&\&\ \%s)\ then\ \%s\ else\ zero"}\<%
\\
\>[.][@{}l@{}]\<[2415I]%
