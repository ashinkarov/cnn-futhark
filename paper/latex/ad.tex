...
\AgdaBound{e}\AgdaSpace{}%
\AgdaSymbol{=}%
\>[1583I]\AgdaFunction{printf}\AgdaSpace{}%
\AgdaString{"(imap\%u\ \%s\ (\textbackslash{}\textbackslash{}\ \%s\ ->\ \%s))"}\<%
\\
\>[1583I][@{}l@{\AgdaIndent{0}}]%
...
\AgdaSymbol{=}\AgdaSpace{}%
\AgdaFunction{printf}%
\>[1615I]\AgdaString{"(isum\%u\ \%s\ (\textbackslash{}\textbackslash{}\ \%s\ ->\ \%s))"}\AgdaSpace{}%
...
\>[1784I]\AgdaSymbol{(}\AgdaFunction{printf}\AgdaSpace{}%
\AgdaString{"(\%s\ /\ \%s)"}\AgdaSpace{}%
\AgdaBound{x}\AgdaSpace{}%
...
\AgdaSymbol{=}\AgdaSpace{}%
\AgdaFunction{printf}%
\>[2253I]\AgdaString{"if\ (\%s\ \&\&\ \%s)\ then\ \%s\ else\ zero"}\<%
\\
\>[.][@{}l@{}]\<[2253I]%
