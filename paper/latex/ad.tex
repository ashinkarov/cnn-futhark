...
\>[2][@{}l@{\AgdaIndent{0}}]%
\>[4]\AgdaKeyword{where}%
\>[526I]\AgdaFunction{map-let}\AgdaSpace{}%
\AgdaSymbol{:}\AgdaSpace{}%
\AgdaSymbol{∀}\AgdaSpace{}%
...
\AgdaSymbol{→}\AgdaSpace{}%
\AgdaFunction{0ᵣ}\AgdaSpace{}%
\AgdaOperator{\AgdaFunction{+}}\AgdaSpace{}%
\AgdaBound{x}%
\>[32]\AgdaOperator{\AgdaDatatype{≡}}\AgdaSpace{}%
\AgdaBound{x}\AgdaSymbol{;}%
\>[38]\AgdaField{+-neutʳ}\AgdaSpace{}%
\AgdaSymbol{:}\AgdaSpace{}%
\AgdaSymbol{∀}\AgdaSpace{}%
\AgdaSymbol{\{}\AgdaBound{x}\AgdaSymbol{\}}\AgdaSpace{}%
\AgdaSymbol{→}\AgdaSpace{}%
...
\\
%
\>[2]\AgdaComment{--\ bop\ :\ Bop\ ->\ String}\<%
\\
%
\>[2]\AgdaComment{--\ bop\ plus\ =\ "F.+"}\<%
\\
%
\>[2]\AgdaComment{--\ bop\ mul\ =\ "F.*"}\<%
\\
%
\\[\AgdaEmptyExtraSkip]%
%
...
\AgdaBound{e}\AgdaSpace{}%
\AgdaSymbol{=}%
\>[1727I]\AgdaFunction{printf}\AgdaSpace{}%
\AgdaString{"(imap\%u\ \%s\ (\textbackslash{}\textbackslash{}\ \%s\ ->\ \%s))"}\<%
\\
\>[1727I][@{}l@{\AgdaIndent{0}}]%
...
\AgdaSymbol{=}\AgdaSpace{}%
\AgdaFunction{printf}%
\>[1759I]\AgdaString{"(isum\%u\ \%s\ (\textbackslash{}\textbackslash{}\ \%s\ ->\ \%s))"}\AgdaSpace{}%
...
\>[1928I]\AgdaSymbol{(}\AgdaFunction{printf}\AgdaSpace{}%
\AgdaString{"(\%s\ /\ \%s)"}\AgdaSpace{}%
\AgdaBound{x}\AgdaSpace{}%
...
\AgdaSymbol{=}\AgdaSpace{}%
\AgdaFunction{printf}%
\>[2397I]\AgdaString{"if\ (\%s\ \&\&\ \%s)\ then\ \%s\ else\ zero"}\<%
\\
\>[.][@{}l@{}]\<[2397I]%
