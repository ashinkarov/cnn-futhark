...
\AgdaBound{e}\AgdaSpace{}%
\AgdaSymbol{=}%
\>[1754I]\AgdaFunction{printf}\AgdaSpace{}%
\AgdaString{"(imap\%u\ \%s\ (\textbackslash{}\textbackslash{}\ \%s\ ->\ \%s))"}\<%
\\
\>[1754I][@{}l@{\AgdaIndent{0}}]%
...
\AgdaSymbol{=}\AgdaSpace{}%
\AgdaFunction{printf}%
\>[1786I]\AgdaString{"(isum\%u\ \%s\ (\textbackslash{}\textbackslash{}\ \%s\ ->\ \%s))"}\AgdaSpace{}%
...
\>[1955I]\AgdaSymbol{(}\AgdaFunction{printf}\AgdaSpace{}%
\AgdaString{"(\%s\ /\ \%s)"}\AgdaSpace{}%
\AgdaBound{x}\AgdaSpace{}%
...
\AgdaSymbol{=}\AgdaSpace{}%
\AgdaFunction{printf}%
\>[2424I]\AgdaString{"if\ (\%s\ \&\&\ \%s)\ then\ \%s\ else\ zero"}\<%
\\
\>[.][@{}l@{}]\<[2424I]%
