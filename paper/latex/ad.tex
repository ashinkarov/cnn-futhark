...
\AgdaBound{e}\AgdaSpace{}%
\AgdaSymbol{=}%
\>[1744I]\AgdaFunction{printf}\AgdaSpace{}%
\AgdaString{"(imap\%u\ \%s\ (\textbackslash{}\textbackslash{}\ \%s\ ->\ \%s))"}\<%
\\
\>[1744I][@{}l@{\AgdaIndent{0}}]%
...
\AgdaSymbol{=}\AgdaSpace{}%
\AgdaFunction{printf}%
\>[1776I]\AgdaString{"(isum\%u\ \%s\ (\textbackslash{}\textbackslash{}\ \%s\ ->\ \%s))"}\AgdaSpace{}%
...
\>[1945I]\AgdaSymbol{(}\AgdaFunction{printf}\AgdaSpace{}%
\AgdaString{"(\%s\ /\ \%s)"}\AgdaSpace{}%
\AgdaBound{x}\AgdaSpace{}%
...
\AgdaSymbol{=}\AgdaSpace{}%
\AgdaFunction{printf}%
\>[2414I]\AgdaString{"if\ (\%s\ \&\&\ \%s)\ then\ \%s\ else\ zero"}\<%
\\
\>[.][@{}l@{}]\<[2414I]%
