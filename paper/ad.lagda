...
We implement the reverse mode of automatic differentiation
...
\[ 
   y = (f \circ g \circ h)\ x
\]
We rewrite it using temporary variables:
\begin{eqnarray*}
  w_0 &=& x \\
  w_1 &=& h\ w_0 \\
  w_2 &=& g\ w_1 \\
...
$\frac{\partial y}{\partial x} 
  = \frac{\partial y}{\partial w_2}
    ...
    traverse function compositions from right to left (following normal evaluation rules), and the reverse mode traverses from left to right, thus computing the recursive relation:
