...
def imap5 'a : (m: i64) -> (n : i64) -> (k : i64) -> (l : i64) -> (t : i64)
...
module nn (F: real) = {
  ...
  def isum3 : (m : i64) -> (n : i64)-> (k : i64)
            -> (i64 -> i64 -> i64 -> real) -> real =
    \ n m k f -> loop r = zero for i < n do r F.+ isum2 m k (f i)

  def isum4 : (m : i64) -> (n : i64)-> (k : i64) -> (l : i64)
            -> (i64 -> i64 -> i64 -> i64 -> real) -> real =
    \ n m k l f -> loop r = zero for i < n do r F.+ isum3 m k l (f i)

  def isum5 : (m : i64) -> (n : i64)-> (k : i64) -> (l : i64) -> (t : i64)
            -> (i64 -> i64 -> i64 -> i64 -> i64 -> real) -> real =
    \ n m k l t f -> loop r = zero for i < n do r F.+ isum4 m k l t (f i)
  ...
  def train_gen :  (inp : [28][28]real) -> (k1 : [6][5][5]real)
                -> (b1 : [6]real) -> (k2 : [12][6][5][5]real)
                -> (b2 : [12]real) -> (fc : [10][12][4][4]real)
                -> (b : [10]real)
                -> (target : [10]real)
                -> ([6][5][5]real,       -- ∂k1
                    ...
                    real)                -- error
                = #[unsafe]
    \ (inp : [28][28]real) (k1 : [6][5][5]real) (b1 : [6]real) 
      (k2 : [12][6][5][5]real)  (b2 : [12]real) (fc' : [10][12][4][4]real) 
      (b : [10]real) (target' : [10]real) ->
